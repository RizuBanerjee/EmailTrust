...
export default function Analytics() {
  ...
  async function loadAnalytics() {
    try {
      setLoading(true);
      setError("");
      const response = await api.get(`/analytics/user/${email}`);
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="muted mt-0.5">Your request volumes and email patterns</p>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <StatCard
                ...
                icon={Key}
                color="violet"
                subtitle="Your active keys"
              />
            </div>

            {/* Charts row */}
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              {/* Top emails bar chart */}
              <div className="card p-5">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="section-title">Top Checked Emails</h3>
                    <p className="muted mt-0.5">Most verified email addresses</p>
                  </div>
              ...
              <div className="card p-5">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="muted mt-0.5">Most common email domains verified</p>
                  </div>
